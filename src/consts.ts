...
export const SITE_DESCRIPTION =
  'Principal Frontend Engineer & UX Architect. Technical deep-dives on web performance, accessibility, Astro, React, and modern CSS architecture.';
...
export const AUTHOR_JOB_TITLE = 'Principal Frontend Engineer & UX Architect';
